...
import { SanityAssetDocument } from '@sanity/client/stega';
...
const Upload = () => {
    ...
    console.log("vidoe assect", videoAsset)
    console.log("saving post", savingPost)
    ...
    const uploadVideo = async (e: any) => {
        ...
        console.log("selectted file", selectedFile)
    ...
    const handlePost = async () => {
        if (caption && videoAsset?._id && topic) {
            ...
            await axios.post(`${BASE_URL}/pages/api/post`, doc);
